  ...
  return (
    <div className="space-y-6 text-[15px] leading-relaxed">
      ...
      <section className="space-y-3">
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            ...
            — 학자금 지원구간 산정 기준, 국가장학금 지원단가, 학자금대출 금리
          </li>
          <li>
            <a
      ...
      <section className="space-y-3">
        ...
        <p>
          학자금 기준값은 해마다 바뀝니다. 기준 중위소득은 매년 8월에 고시되어
          이듬해 1월부터 적용되고, 국가장학금 지원단가는 교육부 예산으로 정해지며,
          학자금대출 금리는 학기마다, 상환기준소득은 매년 바뀝니다.{" "}
          <strong>구간 경계가 1원만 어긋나도 지원액이 수백만원 갈리는 구조</strong>
          라 값이 낡으면 계산기가 조용히 틀린 답을 냅니다. 그래서 고시값 자체를
          숫자로 고정하는 검증 테스트를 따로 두어, 값이 낡으면 조용히 통과하지 않고
          먼저 실패하게 했습니다. 계산기 해설에 실은 표의 숫자도 같은 방식으로
          테스트에 고정해, 상수만 고치고 본문을 빠뜨리는 일을 막습니다.
        </p>
        <p>
